...
(function() {
  ...
  exports.id = function() {
    ...
    generators = [
      function() {
        return h.random(ids) + h.capitalize(h.random(ids));
      }, function() {
        return h.random(ids) + "_" + h.random(ids);
      }, function() {
        return h.random(ids);
      }, function() {
        return h.random(ids) + h.RandomInt(5);
      }
    ];
    ...
    generators = [
      {
        weight: 10,
        f: function() {
          return h.random(strings);
        }
      }, {
        weight: 1,
        f: function() {
          return String(h.RandomInt(100));
        }
      }
    ];
    return h.weightedRandom(generators, function(entry) {
      return entry.weight;
    }).f();
  };
